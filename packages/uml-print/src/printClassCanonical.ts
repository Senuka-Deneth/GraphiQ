...
export type PrintableElement = ClassifierElement | EnumerationElement;

export function shouldPrintElement(element: UmlElement): element is PrintableElement {
  switch (element.elementType) {
    case "class":
    case "interface":
    case "enumeration":
...
export function printPrintableElement(element: PrintableElement): string {
...
export type ClassPrintableRelationship = ClassAssociationRelationship | ClassBinaryRelationship;
...
export function isClassPrintableRelationship(
