...
const RULE_ID = "uc.extend.direction";

export const useCaseExtendDirectionRule: UmlRule = {
  id: RULE_ID,
    ...
    for (const relationship of model.relationships) {
      ...
      if (source.id === target.id) {
        diagnostics.push({
          ...
          ruleId: RULE_ID,
          severity: "error",
          message: "Extend arrow must point at the extended (base) use case, not at itself",
