...
const RULE_ID = "pkg.cannot-import-class-as-package";

export const packageCannotImportClassAsPackageRule: UmlRule = {
  id: RULE_ID,
    ...
    for (const relationship of model.relationships) {
      ...
      if (source.elementType !== "package" || target.elementType !== "package") {
        diagnostics.push({
          ...
          ruleId: RULE_ID,
          severity: "error",
          message: "Cannot import a classifier as a package",
