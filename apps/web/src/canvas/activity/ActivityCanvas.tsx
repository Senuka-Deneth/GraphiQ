...
type ActivityCanvasInnerProps = {
  onSelectedNodeChange?: (nodeId: string | null) => void;
};

function ActivityCanvasInner({ onSelectedNodeChange }: ActivityCanvasInnerProps) {
  ...
  return (
    <div className="h-full w-full" data-testid="activity-canvas">
      <MarkerDefs />
      <ReactFlow
        nodes={nodes}
        edges={edges}
...
export function ActivityCanvas({ onSelectedNodeChange }: ActivityCanvasProps) {
  return (
    <ReactFlowProvider>
      <ActivityCanvasInner onSelectedNodeChange={onSelectedNodeChange} />
    </ReactFlowProvider>
  );
}
