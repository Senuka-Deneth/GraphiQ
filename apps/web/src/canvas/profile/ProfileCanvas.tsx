...
type ProfileCanvasInnerProps = {
  onSelectedNodeChange?: (nodeId: string | null) => void;
};

function ProfileCanvasInner({ onSelectedNodeChange }: ProfileCanvasInnerProps) {
  ...
  return (
    <div className="h-full w-full" data-testid="profile-canvas">
      <MarkerDefs />
      <ReactFlow
        nodes={nodes}
        edges={edges}
...
export function ProfileCanvas({ onSelectedNodeChange }: ProfileCanvasProps) {
  return (
    <ReactFlowProvider>
      <ProfileCanvasInner onSelectedNodeChange={onSelectedNodeChange} />
    </ReactFlowProvider>
  );
}
