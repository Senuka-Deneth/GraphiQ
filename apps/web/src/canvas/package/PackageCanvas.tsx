...
import {
  useDocumentStore,
  type PackageStencilDropKind,
} from "../../store/documentStore.js";
import { PackageNode, packageNodeTypeName } from "./PackageNode.js";
import { packageModelToFlow } from "./modelToFlow.js";

const nodeTypes = {
  [packageNodeTypeName]: PackageNode,
...
type PackageCanvasInnerProps = {
  onSelectedNodeChange?: (nodeId: string | null) => void;
};

function PackageCanvasInner({ onSelectedNodeChange }: PackageCanvasInnerProps) {
  ...
  const { nodes, edges } = useMemo(
    () => packageModelToFlow(model, overlay, diagnostics),
  ...
  return (
    <div className="h-full w-full" data-testid="package-canvas">
      <MarkerDefs />
      <ReactFlow
        nodes={nodes}
        edges={edges}
...
type PackageCanvasProps = {
  onSelectedNodeChange?: (nodeId: string | null) => void;
};

export function PackageCanvas({ onSelectedNodeChange }: PackageCanvasProps) {
  return (
    <ReactFlowProvider>
      <PackageCanvasInner onSelectedNodeChange={onSelectedNodeChange} />
    </ReactFlowProvider>
  );
}
