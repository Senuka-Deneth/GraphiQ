...
import {
  useDocumentStore,
  type DeploymentStencilDropKind,
...
type DeploymentCanvasInnerProps = {
  onSelectedNodeChange?: (nodeId: string | null) => void;
};

function DeploymentCanvasInner({ onSelectedNodeChange }: DeploymentCanvasInnerProps) {
  ...
  return (
    <div className="h-full w-full" data-testid="deployment-canvas">
      <MarkerDefs />
      <ReactFlow
        nodes={nodes}
        edges={edges}
...
type DeploymentCanvasProps = {
  onSelectedNodeChange?: (nodeId: string | null) => void;
};

export function DeploymentCanvas({ onSelectedNodeChange }: DeploymentCanvasProps) {
  return (
    <ReactFlowProvider>
      <DeploymentCanvasInner onSelectedNodeChange={onSelectedNodeChange} />
    </ReactFlowProvider>
  );
}
