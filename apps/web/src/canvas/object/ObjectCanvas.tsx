...
function ObjectCanvasInner({ onSelectedNodeChange }: ObjectCanvasInnerProps) {
  ...
  return (
    <div className="h-full w-full" data-testid="object-canvas">
      <MarkerDefs />
      <ReactFlow
        nodes={nodes}
        edges={edges}
...
export function ObjectCanvas({ onSelectedNodeChange }: ObjectCanvasProps) {
  return (
    <ReactFlowProvider>
      <ObjectCanvasInner onSelectedNodeChange={onSelectedNodeChange} />
    </ReactFlowProvider>
  );
}
