...
type ComponentCanvasInnerProps = {
  onSelectedNodeChange?: (nodeId: string | null) => void;
};

function ComponentCanvasInner({ onSelectedNodeChange }: ComponentCanvasInnerProps) {
  ...
  return (
    <div className="h-full w-full" data-testid="component-canvas">
      <MarkerDefs />
      <ReactFlow
        nodes={nodes}
        edges={edges}
...
export function ComponentCanvas({ onSelectedNodeChange }: ComponentCanvasProps) {
  return (
    <ReactFlowProvider>
      <ComponentCanvasInner onSelectedNodeChange={onSelectedNodeChange} />
    </ReactFlowProvider>
  );
}
