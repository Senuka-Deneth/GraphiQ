...
function KindCanvas({
  ...
  switch (kind) {
    ...
    case "activity":
      return <ActivityCanvas onSelectedNodeChange={onSelectedNodeChange} />;
    case "stateMachine":
      return <StateMachineCanvas onSelectedNodeChange={onSelectedNodeChange} />;
    case "sequence":
      return <SequenceCanvas />;
    case "timing":
      return <TimingCanvas />;
    case "interactionOverview":
      return <InteractionOverviewCanvas onSelectedNodeChange={onSelectedNodeChange} />;
    default:
